...
const TOPICS = [
  ...
  { id: 'tabs', title: 'What each tab is for', icon: 'list-todo', sub: () => 'Today, Bills, Legislators and Outreach',
    items: () => [['Today', 'Your list for the day: testimony steps, reviews, replies, emails to approve and follow-ups, grouped by when they are due. Clear it and you are done. <b>Mine</b> is yours; <b>Team</b> adds what others are waiting on, and inside Team you can pick one person to see their list. <b>Hearings today</b> lists every hearing on the day, filed or not. A message you opened but have not answered stays, marked <b>Seen</b>, until you reply or choose Mark done. On a wide screen, <b>Week</b> shows Monday to Friday side by side. What changed on your bills since yesterday is one folded line. <b>Next deadline</b> in the side panel says which deadline is next and how many of these bills must be heard by then; the line beneath it opens the ones with no hearing yet as suggestions. When the day is quiet, <b>good ways to spend an hour</b> suggests work drawn from where each bill stands — never a deadline, never counted in the badge. Each one says why it came up, and you can mark it <b>Done</b> (it goes on the bill’s timeline), put it off with <b>Not now</b>, or refuse it for that bill for good.'],
      ['Bills', 'Every tracked bill, grouped by where it stands. The strip at the top counts each group and says which deadline is next — tap a count to jump to those rows. Filter, select several to change at once, see muted bills, open the weekly memo or export a CSV. A filter you will want again can be kept: <b>Save this view</b> in the ⋯ menu names it and puts it on the row of view chips, on every device you sign in on. New bills to sort show as a banner.'],

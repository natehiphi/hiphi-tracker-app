...
const PRIVACY = [
  ...
  ['chart-column', 'How the first visit is used', 'To make the first visit better, we count which of its screens people reach and how long they stay, whether they came from a partner’s link, a campaign or another website (its name only), and whether it was a phone or a laptop. Each visit gets a random number that ends when you close the tab. We never record your email, your name, your address, which stance you took, or anything else that could tell who you are. If your browser asks sites not to track you, we record nothing.'],
